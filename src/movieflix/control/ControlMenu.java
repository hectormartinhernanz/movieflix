...
public class ControlMenu {
	...
	public static boolean mostrarMenu() {
		...
		System.out.println("");
		System.out.println("(1) Incluir pel�cula en listado general");
		...
		System.out.println("(6) Mostrar pel�culas suscritas por un usuario");
		System.out.println("(7) Mostrar listado general de pel�culas");
...
public static boolean seleccionOpciones () {
	...
	try {
			...
			System.out.println("error: " + e.toString()  + "    Entrada de teclado err�nea" );
			mostrarMenu();
